...
const getCCP = async (org) => {
    ...
    if (org == "Org1") {
        ...
        ccpPath = path.resolve(__dirname, '..', '..', 'fabric-samples', 'test-network', 'organizations', 'peerOrganizations', 'org2.example.com', 'connection-org2.json');
    } else
        return null
...
async function main() {
    const ccp = await getCCP('Org2');
    enrollAdmin('Org2', ccp);
}
